...
sessionStorage:localStorage).getItem("DataTables_"+a.sInstance+"_"+location.pathname))}catch(b){}},fnStateLoadParams:null,fnStateLoaded:null,fnStateSaveCallback:function(a,b){try{(-1===a.iStateDuration?sessionStorage:localStorage).setItem("DataTables_"+a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": kích hoạt để sắp xếp trong cột tăng dần",
sSortDescending:": kích hoạt để sắp xếp trong cột giảm dần"},oPaginate:{sFirst:"Đầu tiên",sLast:"Cuối cùng",sNext:">>",sPrevious:"<<"},sEmptyTable:"Không có dữ liệu",sInfo:" _START_ / _END_ trong _TOTAL_ ",sInfoEmpty:" 0 / 0 trong 0 ",sInfoFiltered:"(lọc từ tất cả _MAX_ bản ghi)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Show _MENU_ entries",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Tìm:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Không tìm thấy"},
